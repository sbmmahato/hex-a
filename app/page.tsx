...
export default function Home() {
  ...
  return <div className="bg-[#292B32] size-full	w-full h-full  pt-10">
    ...
    <div className="w-[1241px] h-[627px] " style={{
      ...
      {content.map((x,index)=>{return x.type==='content' ? (<div className="shadow-lg bg-[#3B3E47]" style={{  width:'237px', height:'511px'}}>
        
        <img className="w-[217px] h-[385.31px]  ml-[10px] mt-[10px]" src={x.image}/>
        <p className="mt-[12px] mb-[15px]" style={{textAlign:'center'}}>{x.name}</p>

        <div className="w-[217px] h-[54px] bg-[#292B32] ml-[8px] flex" style={{ borderRadius:'2px',  justifyContent:'space-between'}}>
    ...
    </div>) : (<div className="shadow-lg bg-[#3B3E47]" style={{  width:'237px', height:'511px'}}><div className="bg-black w-[47.78px] h-[25px] mt-[10px]  absolute  ml-[179px] font-bold text-[12.8px
]" style={{zIndex:'2px',textAlign:'center'}}>Ad</div> 
      ...
      <div className="h-[918px] w-[1240px] justify-center flex" style={{color:'white', background:'linear-gradient(#18282A,#221A2C)'}}>
      {/* <div className=""> */}
      <p className="w-[505px] h-[52px] font-bold text-[50px] pt-[50px]">Collection Spotlight</p>
      
      {/* </div> */}
      <div className="absolute mt-[150px] w-[1240px] h-[100px] pl-[150px] pr-[150px] justify-center flex">
        <p className="font-normal text-[14px]" style={{textAlign:'center'}}>Discover extraordinary moments with our Spotlight Collection metatickets—exclusive access to premium events for an unforgettable experience. Grab yours today!</p>
      </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
        ...
        {content2.map((x,index)=>(<div key={index} className="shadow-lg bg-[#3B3E47]" style={{width:'257px', height:'624px',marginRight: '50px'}}>
          {/* {x} */}
          <img className="w-[226.1px] h-[401.25px] ml-[14px]  mt-[14px]" src={x.image}/>
          
          <div className="relative">
          <div className="bg-[#221A2C] h-[20px] w-[12px] mt-[11px] absolute" style={{borderTopRightRadius:'20px', borderBottomRightRadius:'20px', left:'0px'}}/>
          <div className="bg-[#221A2C] h-[20px] w-[12px] mt-[11px] absolute" style={{borderTopLeftRadius:'20px', borderBottomLeftRadius:'20px', right:'0px'}}/>
          </div><hr className="mt-[20px] ml-[25px] mr-[25px]" style={{borderTop:'2.5px dashed #818A97', zIndex:'-2px'}}/>
          <p  className="mt-[8px] font-medium text-[17px]" style={{textAlign:'center'}}>{x.name}</p>
          <p className="mt-[10px] font-normal text-[14px]" style={{textAlign:'center'}}>{x.date} | {x.day} | {x.time}</p>
          <p className="mt-[10px] font-normal text-[14px]" style={{textAlign:'center'}}>{x.address}</p>

          <button className="bg-[#000000] w-[213px] h-[36px] ml-[20px] mt-[15px]">{x.button}</button>
